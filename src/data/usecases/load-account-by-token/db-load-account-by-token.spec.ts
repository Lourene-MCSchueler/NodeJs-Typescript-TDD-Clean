...
const makeLoadByTokenRepository = (): LoadAccountByTokenRepository => {
...
const makeSut = (): SutTypes => {
  ...
  const loadAccountByTokenRepositoryStub = makeLoadByTokenRepository()
...
describe('DbLoadAccountByToken Usecase', () => {
  ...
  test('Should return null with LoadAccountByTokenRepository returns null', async () => {
    const { sut, loadAccountByTokenRepositoryStub } = makeSut()
